...
Archived Next.js prototype kept as reference material during the Obsidian plugin migration.

The commands and structure below apply to the archived prototype in this directory, not to the root plugin scaffold.
